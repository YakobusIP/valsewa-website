...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 z-50 w-full bg-[#250000] shadow-md shadow-black/5">
      <div className="mx-auto max-w-[1920px] h-[84px] md:h-[120px] flex items-center justify-between px-5 md:px-14">
