...
import { BOOKING_STATUS, BookingWithAccountEntity, PAYMENT_METHOD_TYPE, PROVIDER } from "@/types/booking.type";
...
export default function BookingDetailPage() {
  ...
  const [paymentMethod, setPaymentMethod] = useState<PAYMENT_METHOD_TYPE | null>(null);
  ...
  if (booking.status !== BOOKING_STATUS.HOLD) {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen text-white bg-black">
        Booking is {statusMap[booking.status]}
      </div>
    );
  }
