                ...
                <div className="max-w-[1920px] mx-auto grid grid-cols-12 gap-8 max-desktop:hidden">
                    ...
                    <div className="col-span-12 lg:col-span-5 space-y-6 mb-4">
                        ...
                        <div className="grid grid-cols-[auto_1fr_auto] grid-rows-2 gap-x-4 gap-y-1 items-center">
                            ...
                            <div className="flex items-center gap-3">
                                <div className={cn("bg-[#F1F1F1] text-[#616161] px-2 py-0.5 text-xs rounded-sm", staatliches.className)}>
                                    {account.isCompetitive
                        ...
                        <div className="space-y-2 text-sm text-[#F9FAFB]">
                            ...
                            <div className="flex justify-between font-semibold">
                                <p>Rent Count:</p>
                                <p className="font-semibold">{formatRentDuration(account.totalRentHour)}</p>
                            </div>
                        ...
                        <div className="space-y-3 bg-[#1C1C1C] p-3 text-sm text-[#F9FAFB] rounded-lg">
                            ...
                            {showSkins && (
                                <div className="space-y-3">
                                    ...
                                    {/* LIST */}
                                    <div className="flex flex-wrap gap-2 max-h-[240px] overflow-y-auto pr-1 [&::-webkit-scrollbar]:w-2 
                  ...
                  ${isDisabled || submitting
                        ...
                        <div className="text-center text-xs text-neutral-400 space-y-3">
                            ...
                            <button
                                type="button"
                                className="w-full border border-[0.5px] border-gray-700 hover:bg-neutral-600 py-3 rounded-lg text-white"
                                onClick={() =>
                                    window.open(
                ...
                <div className="max-w-[1920px] mx-auto grid grid-cols-12 gap-8 desktop:hidden">
                        ...
                        <div className="grid tablet:grid-cols-2 grid-cols-1 tablet:gap-2 gap-5">
                            <div className="flex flex-col">
                                ...
                                <div className="space-y-2 text-xs tablet:text-sm text-[#F9FAFB] max-tablet:pt-8">
                                    ...
                                    <div className="flex justify-between ">
                                        <p>Rent Count:</p>
                                        <p className="">{formatRentDuration(account.totalRentHour)}</p>
                                    </div>
                                    <div className="flex justify-between">
                                        <p>Region: </p>
                                        <p className="">IDN</p>
                            ...
                            <div className="space-y-3 bg-[#1C1C1C] px-4 tablet:pt-5 pt-3 text-xs text-[#F9FAFB] rounded-xl">
                                ...
                                {showSkins && (
                                    <div className="space-y-3">
                                        ...
                                        {/* LIST */}
                                        <div className="flex flex-wrap gap-2 pb-4 max-h-[150px] tablet:max-h-[180px] overflow-y-auto pr-1 [&::-webkit-scrollbar]:w-2 
                                        [&::-webkit-scrollbar-track]:bg-neutral-800
                                        [&::-webkit-scrollbar-track]:rounded-full
                                        [&::-webkit-scrollbar-thumb]:bg-neutral-200
                                        [&::-webkit-scrollbar]:rounded-full
                  ...
                  ${isDisabled || submitting
                        ...
                        <div className="text-center text-xs text-neutral-400 space-y-3">
                            ...
                            <button
                                type="button"
                                className="w-full border border-[0.5px] border-gray-700 hover:bg-neutral-600 tablet:py-3 py-5 rounded-lg text-white"
                                onClick={() =>
                                    window.open(
                                        "https://wa.me/6285175343447?text=Halo%20admin%20VALSEWA%20aku%20butuh%20bantuan%20dong",
                                        "_blank"
