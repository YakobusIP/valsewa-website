...
export interface ApiAccountAccount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    account_code: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    account_rank: Schema.Attribute.String & Schema.Attribute.Required;
    availability_status: Schema.Attribute.Enumeration<
      ['available', 'in_use', 'not_available']
    > &
      Schema.Attribute.Required &
    ...
    > &
      Schema.Attribute.Private;
    next_booking: Schema.Attribute.DateTime;
    next_booking_duration: Schema.Attribute.Integer;
    other_images: Schema.Attribute.Media<'images' | 'files', true>;
    password: Schema.Attribute.String & Schema.Attribute.Required;
    password_updated_at: Schema.Attribute.DateTime & Schema.Attribute.Required;
    price_tier: Schema.Attribute.Relation<
      'oneToOne',
      'api::price-tier.price-tier'
    >;
    publishedAt: Schema.Attribute.DateTime;
    skins: Schema.Attribute.JSON & Schema.Attribute.Required;
    thumbnail: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    total_rent_hour: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
